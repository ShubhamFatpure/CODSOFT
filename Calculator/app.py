# import math 
# def calculator():
#     # first input value1 from user
#     value1 = float(input("Enter the first value: "))

#     # second input value2 from user
#     value2 = float(input("Enter the second value: "))

#     # the user to choose any operation
...
#     operation = input("Enter the arithmetic functions to the operation: ")
